...
public class NewPersDataActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		changeButton.setOnClickListener(new View.OnClickListener()
		{
			...
			{
				// remplir les champs strings private par ceux entr�s par
				// l'utilisateur
				...
				// effacer les champs dans lesquels il a mis les nouveau
				// identifiants
				newMdp.setText("");
				newMdpComf.setText("");
				newName.setText("");
				...
				// voir les champs remplis par l'utilisateur(changements a
				// faire)+effectuer ces changements
				...
				if (!newMdpS.equals(""))
				{
					...
					{
						missingField
								.setText("You must confirm the new password !");
						return;
					}
					if (newMdpComfS.length() < 4)
					{
						missingField
								.setText("The length of the new password is too short !");
						return;
					}
					if (!newMdpComfS.equals(newMdpS))
					{
						missingField
								.setText("The new password and its confirmation aren't identical !");
						return;
					}
				...
				if (!un.equals("") || !deux.equals("") || !trois.equals("")
						|| !quatre.equals(""))
				{
					changeS = "";
				...
				missingField
						.setText("The following changes have been carried out:\n"
